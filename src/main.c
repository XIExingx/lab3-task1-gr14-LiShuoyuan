...
/* Assinging the values to StudentData*/ student.stu_name = "LiShuoyuan"; 
  student.stu_id = 123456; student.stu_age = 22;
/* new structure */
student.stuAddress.street = "4, pr. Nezavisimosti"; student.stuAddress.state = "Minskaya"; student.stuAddress.city = "Minsk"; 
